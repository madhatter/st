...
| 11 | scrollback-edge-scroll (custom) | 0.9.3 | Auto-scroll into scrollback history when dragging a selection to the top or bottom terminal edge |
| 12 | [clickurl](https://st.suckless.org/patches/clickurl/) | 0.8.5 | Ctrl+click to open URLs; modified: TLINE() for scrollback awareness, Ctrl-hold highlighting, non-ASCII fix, double-fork for detached subprocess |
